...
Source0  : https://download.gnome.org/sources/gsettings-desktop-schemas/3.34/gsettings-desktop-schemas-3.34.0.tar.xz
...
%prep
%setup -q -n gsettings-desktop-schemas-3.34.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568066678
...
/usr/share/package-licenses/gsettings-desktop-schemas/COPYING
