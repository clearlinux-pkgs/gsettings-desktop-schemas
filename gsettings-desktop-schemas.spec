...
Source0  : https://download.gnome.org/sources/gsettings-desktop-schemas/3.28/gsettings-desktop-schemas-3.28.0.tar.xz
...
%prep
%setup -q -n gsettings-desktop-schemas-3.28.0
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1522185201
