...
Version  : 3.21.4
Release  : 3
URL      : https://download.gnome.org/core/3.21/3.21.92/sources/gsettings-desktop-schemas-3.21.4.tar.xz
Source0  : https://download.gnome.org/core/3.21/3.21.92/sources/gsettings-desktop-schemas-3.21.4.tar.xz
...
%prep
%setup -q -n gsettings-desktop-schemas-3.21.4
