...
%prep
%setup -q -n gsettings-desktop-schemas-48.0
cd %{_builddir}/gsettings-desktop-schemas-48.0
%patch -P 1 -p1
pushd ..
cp -a gsettings-desktop-schemas-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742589623
