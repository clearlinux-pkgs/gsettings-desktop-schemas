...
Source0  : https://download.gnome.org/sources/gsettings-desktop-schemas/42/gsettings-desktop-schemas-42.0.tar.xz
...
%prep
%setup -q -n gsettings-desktop-schemas-42.0
cd %{_builddir}/gsettings-desktop-schemas-42.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647820688
...
cp %{_builddir}/gsettings-desktop-schemas-42.0/COPYING %{buildroot}/usr/share/package-licenses/gsettings-desktop-schemas/01a6b4bf79aca9b556822601186afab86e8c4fbf
