...
Source0  : https://download.gnome.org/sources/gsettings-desktop-schemas/46/gsettings-desktop-schemas-46.1.tar.xz
...
%prep
%setup -q -n gsettings-desktop-schemas-46.1
cd %{_builddir}/gsettings-desktop-schemas-46.1
%patch -P 1 -p1
pushd ..
cp -a gsettings-desktop-schemas-46.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721140387
