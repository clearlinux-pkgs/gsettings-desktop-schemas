...
Source0  : https://download.gnome.org/sources/gsettings-desktop-schemas/45/gsettings-desktop-schemas-45.0.tar.xz
...
%prep
%setup -q -n gsettings-desktop-schemas-45.0
cd %{_builddir}/gsettings-desktop-schemas-45.0
%patch -P 1 -p1
pushd ..
cp -a gsettings-desktop-schemas-45.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695686267
